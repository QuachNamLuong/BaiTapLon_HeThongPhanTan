...
namespace HTPT_CHD
{
    ...
    {
        public static string serverName = "", databaseName = "", userID = "", password = "";
        ...
        public static string ConnectionString => $"Data Source={serverName};Initial Catalog={databaseName};User ID={userID};Password={password};";
        ...
        public static bool OpenConnection()
        {
            ...
            {
                MessageBox.Show("Error opening connection: " + e.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        ...
        public static bool CloseConnection()
        {
            ...
            {
                MessageBox.Show("Error closing connection: " + e.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
